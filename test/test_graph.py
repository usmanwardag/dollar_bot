...
dummy_x = ['Food', 'Transport', 'Shopping',
           'Miscellaneous', 'Utilities', 'Groceries']
dummy_y = [10.0, 50.0, 148.0, 47.93, 200.0, 55.21]
dummy_categ_val = {'Food': 10.0, 'Transport': 50.0, 'Shopping': 148.0,
                   'Miscellaneous': 47.93, 'Miscellaneous': 47.93, 'Utilities': 200.0, 'Groceries': 55.21}
